...
<body>
  ...
  <div style="font-size: 18px;margin-left: 210px">问答平台 > 查看问题分析 </div>
       ...
       <section class="container">
         <div class="qa-input">
             <div class="question ques-row" data-number="${question.qid}">
                    ...
                    <div class="ques-col">
                        <button type="submit" class="sys-input" >查看问题分析</button>
                    </div>
             </div>
            ...
            series: [
                {
                    ...
                    center: ['50%','60%'],
                    data: [
                        {value: data.yesnumber, name:'选择YES的人数'},
                        {value:data.nonumber, name:'选择NO的人数'}
                    ]
                }
            ],
            itemStyle: {
