...
<div class="content-wrapper">
  <section class="container">
    <div class="box section-qa-content" >
		<div class="section-qa-row">
			...
			<button style="margin-left: 10px;width: 100px;" class="sys-input" id="selectUser">确定</button>
		</div>
    </div>
  </section>
  <div class="talk-container">
	  <div class="talk-bd-left">
		  ...
		  <div>
			  <input style="width: 100%;box-sizing: border-box" type="text" placeholder="请输入要发送的信息" id="msg" class="sys-input " onkeydown="send(event)">
		  </div>
		  <div class="talk-submit">
			  <input type="button" value="发送" class="send btn-talk btn-send" onclick="sendMsg()" >
			  <input type="button" value="清空" class="clear btn-talk btn-close" onclick="clearAll()">
		  </div>
	  </div>
